...
type FibonacciClient interface {
	FibonacciSequence(ctx context.Context, in *FibonacciRequest, opts ...grpc.CallOption) (*FibonacciResponse, error)
}
...
func (c *fibonacciClient) FibonacciSequence(ctx context.Context, in *FibonacciRequest, opts ...grpc.CallOption) (*FibonacciResponse, error) {
	out := new(FibonacciResponse)
	err := c.cc.Invoke(ctx, "/api.Fibonacci/FibonacciSequence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FibonacciServer interface {
	FibonacciSequence(context.Context, *FibonacciRequest) (*FibonacciResponse, error)
...
func (UnimplementedFibonacciServer) FibonacciSequence(context.Context, *FibonacciRequest) (*FibonacciResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FibonacciSequence not implemented")
}
...
func _Fibonacci_FibonacciSequence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FibonacciRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FibonacciServer).FibonacciSequence(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Fibonacci/FibonacciSequence",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FibonacciServer).FibonacciSequence(ctx, req.(*FibonacciRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// Fibonacci_ServiceDesc is the api.ServiceDesc for Fibonacci service.
// It's only intended for direct use with api.RegisterService,
...
var Fibonacci_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "FibonacciSequence",
			Handler:    _Fibonacci_FibonacciSequence_Handler,
		},
	},
